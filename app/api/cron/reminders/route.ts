...
const MESSAGES = [
  { title: "Polaris 🌸", body: "How are you feeling today? A quick log keeps your patterns sharp 💕" },
  ...
  { title: "Polaris ✨", body: "Your cycle is always changing. Capture today so nothing gets lost 🌙" },
]
