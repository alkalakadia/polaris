      ...
      <div className="mt-5 rounded-3xl border border-g-border bg-white p-5 shadow-girly">
        {content === null && !error ? (
          <div className="space-y-2.5">
            ...
            <p className="pt-1 text-xs font-bold text-g-ink-3">Polaris is writing this for you… ✍️🌸</p>
          </div>
        ) : error ? (
          ...
          <>
            ...
            <p className="mt-5 rounded-2xl bg-g-lavender-soft px-3 py-2.5 text-xs font-bold text-g-ink">
              🩺 This is general education, not medical advice. Polaris never diagnoses — please talk to
