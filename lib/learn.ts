 ...
 *  the "Latest research" feed and Ask MyPMOS add fresh, cited content on top. */
...
export const ARTICLES: Article[] = [
  {
    ...
    brief:
      "A beginner-friendly overview of PMOS: what it is, the Rotterdam criteria and the four phenotypes (A/B/C/D) at a high level, why ovulation and periods become irregular, and that 'polycystic' is a bit of a misnomer.",
  },
  {
    ...
    brief:
      "What insulin resistance is, how it connects to PMOS symptoms and androgens, and evidence-supported lifestyle approaches (balanced meals, fiber, protein, movement) in general, non-prescriptive terms.",
  },
  {
    id: "inositol-2026",
    topic: "New research",
    ...
    brief:
      "An evidence-based summary of inositol in PMOS: myo-inositol vs d-chiro-inositol, the commonly studied 40:1 ratio, what trials suggest about cycle regularity and insulin markers, and honest limitations. No doses or prescriptions.",
  },
  {
    id: "skin-hair",
    topic: "Skin & hair",
    ...
    brief:
      "Why PMOS can cause acne and unwanted hair (androgens), and the general categories of approaches (skincare, hair-removal methods, and the kinds of treatments a doctor or dermatologist might discuss) without giving prescriptions.",
  },
  {
    id: "mood",
    topic: "Mental health",
    ...
    tags: ["mood", "fatigue"],
    brief:
      "The connection between PMOS and mental health (higher rates of anxiety and depression), why that happens, gentle self-support ideas, and a clear nudge to seek professional support when needed.",
  },
  {
    id: "fertility",
    topic: "Fertility",
    ...
    tags: ["fertility", "ttc"],
    brief:
      "How PMOS affects ovulation and fertility, the general landscape of options people discuss with their care team, and encouragement that many people with PMOS conceive. Non-prescriptive, no specific protocols.",
  },
]
